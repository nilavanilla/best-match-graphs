...
Navigate the bash to the directory where the program files lay.
Use the command:	make

To visualize the graphs you need the program Graphviz.
Install it with: 	sudo apt-get install graphviz

The survey of datas of the robustness of random cBMGs needs a directory called "output". If there is not such an directory in the directory of the program files you need to create one.
